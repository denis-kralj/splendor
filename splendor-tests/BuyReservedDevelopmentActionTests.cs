...
public class BuyReservedDevelopmentActionTests
{
    [Test]
    public void ShouldFailIfDevelopmentNotReserved()
    {
        ...
        var sut = new BuyReservedDevelopmentAction(developmentToBuy);
    ...
    public void ShouldFailIfPlayerCannotPayPrice()
    {
        ...
        player.TryReserve(developmentToBuy);
        var sut = new BuyReservedDevelopmentAction(developmentToBuy);
